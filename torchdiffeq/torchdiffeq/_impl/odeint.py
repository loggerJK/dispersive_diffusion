...
def odeint(func, y0, t, *, rtol=1e-7, atol=1e-9, dispersive_kwargs=None, method=None, options=None, event_fn=None):
    ...
    solver = SOLVERS[method](func=func, y0=y0, rtol=rtol, atol=atol, dispersive_kwargs=dispersive_kwargs, **options)
